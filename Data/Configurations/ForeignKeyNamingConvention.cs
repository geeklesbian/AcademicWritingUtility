...
namespace AcademicWritingUtility.Data
{
    ...
    public class ForeignKeyNamingConvention : IStoreModelConvention<AssociationType>
    {
        ...
        public virtual void Apply(AssociationType association, DbModel model)
        {
        ...
        protected bool DoPropertiesHaveDefaultNames(ReadOnlyMetadataCollection<EdmProperty> properties, string roleName, ReadOnlyMetadataCollection<EdmProperty> otherEndProperties)
        {
        ...
        protected void NormalizeForeignKeyProperties(ReadOnlyMetadataCollection<EdmProperty> properties)
        {
            for (int i = 0; i < properties.Count; ++i)
            {
